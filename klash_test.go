...
func TestPositional(t *testing.T) {
	...
	args, err := klash.ParseArguments(osargs, &parameters, true)
...
func TestSimple(t *testing.T) {
	...
	_, err := klash.ParseArguments(osargs, &parameters, true)
...
func TestNoStop(t *testing.T) {
	...
	parameters := TestStruct{}
	osargs := []string{"--name", "Jack", "play", "--nickname", "derp"}
	_, err := klash.ParseArguments(osargs, &parameters, false)
