...
func TestPositional(t *testing.T) {
	...
	args, err := klash.ParseArguments("test", osargs, &parameters, "Test", true)
...
func TestSimple(t *testing.T) {
	...
	_, err := klash.ParseArguments("test", osargs, &parameters, "Test", true)
...
func TestNoStop(t *testing.T) {
	...
	parameters := TestStruct{}
	osargs := []string{"--name", "Jack", "play", "--nickname", "derp"}
	_, err := klash.ParseArguments("test", osargs, &parameters, "Test", false)
